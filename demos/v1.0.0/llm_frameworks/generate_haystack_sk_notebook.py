#!/usr/bin/env python3
"""Generate the Haystack & Semantic Kernel integration notebook."""
...
add_code_cell("""# Cell 8: Create Mock Embedding Function (for demo without API keys)
...
# Cell 9: DocumentStore markdown
add_markdown_cell("""## 📦 SynaDocumentStore Demo <a id="documentstore"></a>
...
# Cell 10: DocumentStore Demo
add_code_cell("""# Cell 10: SynaDocumentStore Demo
...
# Cell 11: Filter Documents
add_code_cell("""# Cell 11: Filter Documents Demo
if doc_store:
...
# Cell 12: Haystack Pipeline markdown
add_markdown_cell("""## 🔗 Haystack Pipeline Demo <a id="haystack-pipeline"></a>
...
add_code_cell("""# Cell 13: Haystack Pipeline Demo
...
# Cell 14: SK Memory markdown
add_markdown_cell("""## 🧠 Semantic Kernel Memory Demo <a id="sk-memory"></a>
...
# Cell 15: SK Memory Demo
add_code_cell("""# Cell 15: Semantic Kernel Memory Demo
if HAS_SYNADB:
...
# Cell 16: SK Functions markdown
add_markdown_cell("""## ⚡ SK Semantic Functions <a id="sk-functions"></a>

Let's demonstrate how semantic functions can use SynaDB memory for context-aware responses.""")

# Cell 17: SK Functions Demo
add_code_cell("""# Cell 17: SK Semantic Functions Demo
if memory:
...
# Cell 18: Comparison markdown
add_markdown_cell("""## 📊 Cross-Framework Comparison <a id="comparison"></a>

Let's compare how the same RAG task is implemented across different frameworks using SynaDB.""")

# Cell 19: Comparison Demo
add_code_cell("""# Cell 19: Cross-Framework Comparison
...
# Cell 20: Portability markdown
add_markdown_cell("""## 🔄 Data Portability Demo <a id="portability"></a>

One of SynaDB's key advantages is data portability between frameworks. Let's demonstrate sharing data.""")

# Cell 21: Portability Demo
add_code_cell("""# Cell 21: Data Portability Demo
if HAS_SYNADB:
...
# Write the notebook
with open('14_haystack_semantic_kernel.ipynb', 'w') as f:
    json.dump(notebook, f, indent=1)

print("Generated 14_haystack_semantic_kernel.ipynb")
